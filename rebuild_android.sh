...
cmake ../.. -DCMAKE_TOOLCHAIN_FILE=../../toolchains/android.cmake -DANDROID_NDK=$NDK_HOME -DCMAKE_BUILD_TYPE=Release -DANDROID_ABI=armeabi-v7a -DCMAKE_INSTALL_PREFIX=../../__platforms/android-armeabi-v7a -DJNI_PACKAGE_NAME=com_example_x_framework 
popd
./build_android.sh $1
